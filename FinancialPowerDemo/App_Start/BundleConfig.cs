...
namespace FinancialPowerDemo.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/twitter-bootstrap").Include(
                    "~/Scripts/bootstrap*"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/file-upload").Include(
                    "~/Scripts/blue-imp-jquery-file-upload/*"));
            ...
            bundles.Add(new StyleBundle("~/Content/file-upload").Include(
                    "~/Content/blue-imp-jquery-file-upload/*"));
        }
    }
}